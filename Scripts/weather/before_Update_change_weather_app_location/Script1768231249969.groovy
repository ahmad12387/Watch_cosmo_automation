...
// Tap Enter Location
"adb shell input tap 120 19".execute().waitFor()
Thread.sleep(1500)

// Type texas
"adb shell input text texas".execute().waitFor()
Thread.sleep(1500)

// Tap blue OK arrow
"adb shell input tap 210 215".execute().waitFor()
Thread.sleep(2000)

// Tap first suggestion (Texas City)
"adb shell input tap 120 83".execute().waitFor()
Thread.sleep(3000)

KeywordUtil.logInfo("✅ Weather location changed successfully")
